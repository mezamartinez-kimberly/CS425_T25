  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Padding(
          padding: EdgeInsets.only(top: 20, left: 65), // Adjust the bottom value as per your requirement
          child: Text(
...
//   //   DropdownButton(
//   //     isExpanded: true,
//   //     value: list, // A global variable used to keep track of the selection
//   //     items: list.map((item) {
//   //       return DropdownMenuItem(
//   //         value: item,
//   //         child: Text(item),
//   //       );
//   //     }).toList(),
//   //     onChanged: (selectedItem) => setState(() => list = selectedItem),
//   //     )
//   //   ); not done lol
//   // }
...
//   late bool isSwitched = isNotificationOnOff() as bool;

//   //create a function that will call the isNotificationOnOff function
//   Future<bool> isNotificationOnOff() async {
//     //call /isNotificationOnOff from backend
//     String onOffHolder = await BackendUtils.getIsNotificationsOn();
//     return convertStringToBoolSwitch(onOffHolder);
//   }
